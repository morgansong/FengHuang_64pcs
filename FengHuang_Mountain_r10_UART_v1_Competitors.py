...
class ReadMeasurement_SFA3x():
    def __init__(self):
        ...
        try:
            self.dart.append(Singleshot_dart_WZS.dart_WZS(dart_list[0]))
            self.num_usbDevice = self.num_usbDevice + 1
            
            self.uart_SNList['65'] = 'Prosense1'
            
        except:
            pass
            
        try:
            self.dart.append(Singleshot_dart_WZS.dart_WZS(dart_list[1]))
            self.num_usbDevice = self.num_usbDevice + 1
            
            self.uart_SNList['66'] = 'Prosense2'
        except:
            pass
            
        try:
            self.cubic.append(Singleshot_cubic_CB.CubicCBHCHO(cb_list[0]))
            self.num_usbDevice = self.num_usbDevice + 1
            
            self.uart_SNList['67'] = 'Cubic1'
        except:
            pass
            
        try:
            self.cubic.append(Singleshot_cubic_CB.CubicCBHCHO(cb_list[1]))
            self.num_usbDevice = self.num_usbDevice + 1
            
            self.uart_SNList['68'] = 'Cubic2'
        except:
            pass
    ...
    def UpdateValues(self):
        ...
        try: 
            result_dict_d1 = self.dart[0].get_new_measurements()
            if result_dict_d1:
                data['65'] = [result_dict_d1[1][1]]
        except:
            pass
            
        try: 
            result_dict_d2 = self.dart[1].get_new_measurements()
            if result_dict_d2:
                data['66'] = [result_dict_d2[1][1]]
        except:
            pass
            
        try:
            result_dict_c1 = self.cubic[0].get_new_measurements()
            if result_dict_c1:
                data['67'] = [result_dict_c1[0][1],result_dict_c1[4][1],result_dict_c1[3][1]]
                
        except:
            pass
            
        try:
            result_dict_c2 = self.cubic[1].get_new_measurements()
            if result_dict_c2:
                data['68'] = [result_dict_c2[0][1],result_dict_c2[4][1],result_dict_c2[3][1]]
        except:
            pass
            
        print(data)
        
        if len(data) == self.num_usbDevice:
            # print(data)
